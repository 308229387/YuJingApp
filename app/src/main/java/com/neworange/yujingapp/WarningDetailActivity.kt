...
class WarningDetailActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var url = "https://www.neworangegroup.com/play/index.html?id=" + clickedItem.id + "&code=" + code + "&type=" + type + "&uuid=" + clickedItem.uuid
//        var url = "https://www.neworangegroup.com/play/index.html?id=1731&code=3a84d444-ce84-472b-a285-976f9be1dc9f&type=video"
