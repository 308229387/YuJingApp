...
class WarningViewModel : ViewModel() {
    ...
    private val _warningListLiveData = MutableLiveData<NetworkResult<WarningListResponse>>()

    // 对外暴露 LiveData（只读）
    val warningListLiveData: LiveData<NetworkResult<WarningListResponse>> = _warningListLiveData
